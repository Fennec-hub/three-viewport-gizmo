...
You can try ViewportGizmo directly in your browser on [jsFiddle](https://jsfiddle.net/wpxbcj6h/).
...
import { ViewportGizmo } from "https://unpkg.com/three-viewport-gizmo@1.0.2/dist/three-viewport-gizmo.js";
```
...
<script type="importmap">
  {
    "imports": {
      ...
      "three-viewport-gizmo": "https://unpkg.com/three-viewport-gizmo@1.0.2/dist/three-viewport-gizmo.js"
    }
  }
</script>
