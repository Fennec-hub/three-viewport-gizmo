...
import { ResizableGrid } from "./utils/ResizableGrid";
...
export function grid() {
  ...
  const resizableGrid = new ResizableGrid(root, renderer.domElement);
  const container = resizableGrid.canvasContainer;
